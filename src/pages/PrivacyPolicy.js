...
function PrivacyPolicy() {
  return (
    <div className="termsandconditions">
      <h1>Privacy Policy for InByteTechnologies</h1>

      <p>
        At InByte, accessible from https://inbytetechnologies.com, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        InByte and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in InByte. This policy is not applicable to any
      ...
      <p>
        InByte follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        advertising partners of InByte.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on InByte, which are sent directly
      ...
      <p>
        Note that InByte has no access to or control over these cookies that are
      ...
      <p>
        InByte's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        InByte does not knowingly collect any Personal Identifiable Information
