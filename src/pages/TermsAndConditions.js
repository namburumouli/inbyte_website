...
function TermsAndConditions() {
  return (
    <div className="termsandconditions">
      ...
      <p>Welcome to InByteTechnologies!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of InByteTechnologies's Website, located at
        https://inbytetechnologies.com.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use InByteTechnologies if you do not
      ...
      <p>
        ...
        subject to, prevailing law . Any use of the above
      ...
      <p>
        We employ the use of cookies. By accessing InByteTechnologies, you
        agreed to use cookies in agreement with the InByteTechnologies's Privacy
        Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, InByteTechnologies and/or its licensors own the
        intellectual property rights for all material on InByteTechnologies. All
        intellectual property rights are reserved. You may access this from
        InByteTechnologies for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from InByteTechnologies</li>
        <li>Sell, rent or sub-license material from InByteTechnologies</li>
        <li>Reproduce, duplicate or copy material from InByteTechnologies</li>
        <li>Redistribute content from InByteTechnologies</li>
      </ul>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        InByteTechnologies does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of InByteTechnologies,its agents and/or affiliates.
        ...
        InByteTechnologies shall not be liable for the Comments or for any
      ...
      <p>
        InByteTechnologies reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant InByteTechnologies a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of InByteTechnologies; and (d) the
      ...
      <p>
        ...
        e-mail to InByteTechnologies. Please include your name, your
      ...
      <p>
        No use of InByteTechnologies's logo or other artwork will be allowed for
